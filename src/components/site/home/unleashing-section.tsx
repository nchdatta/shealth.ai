  ...
  return (
    <Container as="section" id="about" className="py-10">
      <div className="w-full max-w-2xl mx-auto flex flex-col items-center text-center">
        ...
        <span className="inline-block w-14 h-[1px] bg-gray-600 my-16" />

        <Button
          size="lg"
          className="h-12 has-[>svg]:px-6 text-white font-bold  bg-blue-600 hover:bg-blue-800 rounded-3xl flex justify-between items-center gap-10"
        >
